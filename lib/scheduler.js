module.exports = function() {
    ...
    scheduler.create = function (config) {
        ...
        self._state = false;
        self._useontopic = true;
        self._useofftopic = true;
    ...
    scheduler.useontopic = function (useontopic) {
        if (typeof useontopic === 'undefined') return self._useontopic;
        self._useontopic = useontopic;
    };
    scheduler.useofftopic = function (useofftopic) {
        if (typeof useofftopic === 'undefined') return self._useofftopic;
        self._useofftopic = useofftopic;
    };
